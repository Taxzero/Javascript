...
//심볼타입
+Symbol()           // TypeError: cannot convert a Sybol value to a number
...
//2.Object.prototype.toString 메소트 사용하는 방법
// 숫자 타입 => 문자열 타입
...
console.log(elem.value); // TypeError: Canot read property 'value' of null
